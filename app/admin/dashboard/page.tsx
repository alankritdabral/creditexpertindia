      ...
      if (apiData.success) {
        apiData.reports.forEach((data: any) => {
          ...
          if (stats[branch]) {
            ...
            let cost = bureau.startsWith("experian") ? 10.62 : bureau.startsWith("crif") ? 14.16 : 59;
            if (data.fallbackData?.fallback_from_experian) {
              cost += 10.62; // Include the failed Experian hit cost
            }

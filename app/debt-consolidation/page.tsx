      ...
      <section className="relative w-full pt-32 pb-24 lg:pt-40 lg:pb-32 bg-background overflow-hidden border-b border-slate-200">
        ...
        <div className="container-narrow text-center relative z-10">
          ...
          <h1 className="mt-3 text-3xl font-extrabold tracking-tight sm:text-5xl leading-tight text-slate-900">
            ...
            <span className="text-slate-600">One Simpler Repayment Plan</span>
          </h1>
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a
              href="#calculator"
              className="inline-flex h-12 items-center justify-center rounded-full border border-slate-200 bg-white px-8 text-sm font-semibold text-slate-900 hover:bg-slate-50 transition-colors shadow-sm"
            >
              Calculate Savings
            </a>
          </div>

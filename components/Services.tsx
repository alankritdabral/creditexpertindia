...
export function Services() {
  return (
    <section id="services" className="bg-gradient-to-b from-slate-50 to-white py-16 sm:py-24">
        ...
        <Reveal>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 text-[30px] font-extrabold tracking-tight text-[#091328] sm:text-[40px]">
              Solutions Tailored to Your Credit Situation
            </h2>
            <p className="mt-3 text-sm leading-7 text-slate-600 sm:text-base">
              We are not just another loan aggregator. We provide structured guidance to help you replace high-cost debt with manageable loan options through our network.
            </p>
          </div>
        </Reveal>
              ...
              >
                <div
                  className={`group relative flex h-full flex-col justify-between overflow-hidden rounded-3xl p-7 sm:p-8 transition-all duration-300 ${
                    featured
                      ? "border-2 border-emerald-500/40 bg-gradient-to-br from-white via-emerald-50/20 to-white shadow-xl hover:shadow-2xl"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-2.5 text-sm leading-6 text-slate-600 font-medium">{s.desc}</p>
                  </div>

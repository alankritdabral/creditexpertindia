...
export function WhoWeHelp() {
  return (
    <section className="bg-slate-50/80 py-16 sm:py-24 border-y border-icy-blue/80">
      <div className="container-narrow grid gap-10 lg:grid-cols-2 lg:items-center">
        <Reveal>
          <div>
            ...
            <p className="mt-3 text-sm leading-7 text-brand-black/80 sm:text-base">
        ...
        <motion.div
          ...
          className="rounded-3xl border border-icy-blue/90 bg-white p-7 shadow-md sm:p-8"
        >
          ...
          <ul className="space-y-3.5">
            {whoWeHelp.map((item) => (
              <li key={item} className="flex items-start gap-3 text-xs sm:text-sm font-semibold text-brand-black/90">
          ...
          <div className="mt-6 rounded-2xl bg-slate-50 p-4 text-[11px] font-medium leading-5 text-brand-black/70 border border-slate-100">
